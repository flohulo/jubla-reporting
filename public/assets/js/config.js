...
window.APP_CONFIG = {
    ...
    links: {
        ...
        shopping: { label: "Einkaufsliste", url: "/shopping.html" },
        github: { label: "Projekt auf GitHub", url: "https://github.com/flohulo/jubla-reporting" },
        license: { label: "Lizenz", url: "/license.html" },
        legal: { label: "Rechtliche Hinweise", url: "/legal.html" },
        legalText: "Rechtliches",
        reportIssue: "Fehler melden"
    },

    shopping: {
        pageTitle: "Schareinkaufliste",
        pageSubtitle: "Alle in der Schar sehen dieselbe Liste.",
        intro: "Tragt gemeinsam ein, was noch fehlt. Erledigte Posten lassen sich direkt abhaken oder entfernen.",
        loginTitle: "Anmelden",
        nameLabel: "Dein Name",
        pinLabel: "Schar-PIN",
        shoppingTitle: "Einkaufsliste",
        shoppingHint: "Die Liste ist fÃ¼r alle Leitenden mit demselben PIN sichtbar.",
        itemLabel: "Artikel",
        amountLabel: "Menge",
        ...
        addBtn: "Zur Liste",
        loginBtn: "Anmelden",
        clearDoneBtn: "Erledigte lÃ¶schen",
        hideDoneBtn: "Erledigte ausblenden",
        showDoneBtn: "Erledigte anzeigen",
        statsOpen: "Offen",
        statsDone: "Erledigt",
        statsTotal: "Artikel",
        emptyState: "Noch keine Artikel auf der Liste.",
        loading: "Ladeâ€¦",
        saving: "Wird gespeichertâ€¦",
        updateDone: "Erledigt",
        updateUndo: "Wieder offen",
        removeBtn: "Entfernen",
        addSuccess: "Artikel hinzugefÃ¼gt.",
        actionSuccess: "Liste aktualisiert.",
        validationMissing: "Bitte einen Artikel eingeben.",
        noItemsToClear: "Keine erledigten Artikel zum LÃ¶schen vorhanden.",
        genericError: "Fehler. Bitte spÃ¤ter nochmals versuchen."
    },
